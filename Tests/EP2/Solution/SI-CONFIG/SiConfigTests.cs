...
namespace SIX.SCS.QA.Tests.EP2.SICONFIG
{
    ...
    public class SiConfigTests
    {
        ...
        private Mock<IProvideSecurityInfo> _securityInfoProvider = null;
        private RequestResponseClientRequestResponseProtocol _requestResponseClientProtocol;
        private ComConfig _comConfig;

        private Mock<IClientSessionHandler> _testHandler = null;
        private string _trmWithCfgNtf = "21011222"; //610000001
        private byte[] _trmWithCfgCompSecret = "0x483B8FC350D0557303D67DB1D53858F7".AsHexBytes();

        private string _trmWithResetNtf = "20074641"; //610000002
        private byte[] _trmWithResetNtfCompSecret = "0x21F67299BFCE2F39F336AFBC4D65943A".AsHexBytes();
        private long _scId = 8000000001;
        private string _scIdStr = "08000000001";

        private string _pubkey = "";
        //        ceptest
        private string remoteHost = "mdzhwcweb01";//"localhost";
        private int remotePort = 8115;
        ...
        public void Setup()
        {
            ...
            _requestResponseClientProtocol = new RequestResponseClientRequestResponseProtocol(new ClientFrameAdapter(new PullComClient()), new ClientMessageDispatcher(), MessageVersionMapper.Builder.AddFromAssemblyOfType<SessionStart>().Build());
        ...
        public void Given_TerminalNeedsConfig_TELDSent_AndConfigSent()
        {
            ...
            dataNotificationHandler.Verify(
                x =>
                x.Respond(It.Is<ConfigDataNotificationV0500>(n => n.Aisd[0].CommAddrAcqInitSrv.CommIpAddr == "153.46.226.2"
        ...
        public void Given_DoCatchCOnfig()
        {
            ...
            dataRequest.Setup(x => x.Respond(It.Is<ConfigDataRequest>(r => r.ConfDataObj == "TELD"))).Returns(new ConfigDataResponse()
            {
                TrmID = _trmWithCfgNtf,
                SCID = _scId,
                MsgNum = 124,
        ...
        public void Given_ServerError_TheServerDoesNotDropTheConnection()
        {
            ...
            _testHandler.Setup(x => x.EnrichErrorMessage(It.IsAny<ErrorNotification>(), null)).Callback((ErrorNotification e, Exception ex) =>
            {
                e.SCId = _scIdStr;
            ...
            _testHandler.Verify(
                x => x.EnrichErrorMessage(It.Is<ErrorNotification>(e => e.ErrorCode == ErrorCodes.UnexpectedMessage), It.IsAny<Exception>()),
                Times.Once());
