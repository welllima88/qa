...
namespace Six.Scs.Ep2.SI.Config.Messages.Containers
{
    public class CtlessTrmCapPerKnl
    {
        ...
        [Ep2DataElement(TagName = "CtlessDataExchangeFlag", TagPrefix = "ep2", DataType = Ep2DataType.n,
            IsMandatory = true)]
        ...
        [Ep2DataElement(TagName = "CtlessKnlVers", TagPrefix = "ep2", DataType = Ep2DataType.ans, MaxLength = 16,
            IsMandatory = true)]
