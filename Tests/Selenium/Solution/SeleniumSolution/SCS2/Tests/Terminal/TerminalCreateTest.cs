...
namespace SIX.SCS.QA.Selenium.Tests.SCSPlatin.Tests.Terminal
{
    ...
    public class TerminalCreateTest
    {
        ...
        public void YomaniDefaultFktCreateTerminal()
        {
            ...
            Assert.AreEqual(_terminalCreate.TerminalConfigCreate.TerminalType, "yomani");
            Assert.AreEqual(_terminalCreate.TerminalConfigCreate.Protocol, "EP2");
            Assert.AreEqual(_terminalCreate.TerminalConfigCreate.NetType, "TCP/IP ep2 (IP) (TCPIPEP2)");

            _terminalCreate.TerminalConfigCreate.ContinueButton.Click();

            Assert.AreEqual(_terminalCreate.TerminalConfigDetailsCreate.Article, "yomani AUTONOM, TCP/IP ep2 (IP)");
