...
namespace SIX.SCS.QA.Selenium.Tests.SCSPlatin.Tests.Terminal.EventLog
{
    ...
    public class BasicEventLogTest
    {
        ...
        {
            Assert.IsTrue(_terminalEventLog.EventList.Count == 0, "at least List with");
        ...
        {
            Assert.IsTrue(_terminalEventLog.SeverityList.Options.Count == 4, "number of time span options");
        }
    }
}