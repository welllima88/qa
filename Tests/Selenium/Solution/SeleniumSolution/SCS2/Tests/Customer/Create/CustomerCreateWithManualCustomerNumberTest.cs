...
{
    [TestClass]
    public class CustomerCreateWithManualCustomerNumberTest
    {
        ...
        [TestMethod]
        public void AlreadyUsedCustomernumber()
        {
            _customerCreate.CustomerNumber = "1";
        ...
        [TestMethod]
        public void NegativeCustomernumber()
        {
            _customerCreate.CustomerNumber = "-51";
            _customerCreate.SaveButton.Click();
            Assert.AreEqual(1, _formAlerts.FormAlertList.Count);
        ...
        {
            _customerCreate.CustomerNumber = "ABCxy";
            _customerCreate.SaveButton.Click();
            Assert.AreEqual(1, _formAlerts.FormAlertList.Count);
            CollectionAssert.Contains(_formAlerts.FormAlertList, "Kundennummer ungültig");
        }
