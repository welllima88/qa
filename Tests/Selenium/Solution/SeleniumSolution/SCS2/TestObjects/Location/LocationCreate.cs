...
namespace SIX.SCS.QA.Selenium.Tests.SCSPlatin.TestObjects.Location
{
    public class LocationCreate : WebObject, ILocationCreate
    {
        ...
        public string Zip
        {
            set
            {
                Driver.FindAdaptedElement(By.CssSelector(Prefix +"_ZIP")).TypeText(value);
            }
        }
        ...
        public string AdressAddition
        {
            set
            {
                Driver.FindAdaptedElement(By.CssSelector(Prefix +"_AddressAddition")).TypeText(value);
            }
        }
        ...
        public string Telephone
        {
            set
            {
                Driver.FindAdaptedElement(By.CssSelector(Prefix +"_Telephone")).TypeText(value);
            }
        }
        ...
        public string Mobile
        {
            set
            {
                Driver.FindAdaptedElement(By.CssSelector(Prefix +"_Mobile")).TypeText(value);
            }
        }
        ...
        public string SapNumber
        {
            set
            {
                Driver.FindAdaptedElement(By.CssSelector(Prefix +"_SapNumber")).TypeText(value);
            }
        }
