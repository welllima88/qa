...
namespace Six.Saferpay.Backoffice.Test.Pages.Menu
{
    public class MySaferpay
    {
        ...
        public IWebElement BatchProcessing;

        [FindsBy(How = How.CssSelector, Using = "div#menu li a[href*='/Support/TicketOverview']")]
